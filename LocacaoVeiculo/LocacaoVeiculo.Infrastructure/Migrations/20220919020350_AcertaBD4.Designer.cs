...
namespace LocacaoVeiculo.Infrastructure.Migrations
{
    ...
    [Migration("20220919020350_AcertaBD4")]
    partial class AcertaBD4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocacaoVeiculo.Domain.Entities.Marca", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocacaoVeiculo.Domain.Entities.Modelo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocacaoVeiculo.Domain.Entities.Veiculo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocacaoVeiculo.Domain.Entities.Veiculo", b =>
                {
                    b.HasOne("LocacaoVeiculo.Domain.Entities.Marca", "Marca")
                        .WithMany()
                        .HasForeignKey("Id_Marca")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LocacaoVeiculo.Domain.Entities.Modelo", "Modelo")
                        .WithMany()
